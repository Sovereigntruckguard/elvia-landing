...
const promoVideos = [
  ...
  },
  {
    ...
    description:
      "Simulaciones completas para que entrenes antes de la próxima inspección.",
  },
  {
    src: "/elvia/videos/pronunciation.mp4",
    title: "Pronunciación asistida",
    description:
      "Mejora tu pronunciación con ejemplos prácticos y repetición guiada.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Ejemplo real de cómo el agente cognitivo corrige y guía tus respuestas.",
  },
  {
    src: "/elvia/videos/retro-ia-2.mp4",
    title: "Retroalimentación IA – Caso 2",
    description:
      "Más ejemplos de cómo la IA te acompaña en contexto dentro del curso.",
  },
];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="w-full fixed top-0 left-0 z-50 bg-black/60 backdrop-blur-md border-b border-[#2A2A2A]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="/elvia/logo-elvia.png" className="w-10" alt="Logo EL-VÍA" />
          ...
          <div className="flex items-center gap-3 text-xs md:text-sm">
            <a
              href="tel:+16085576282"
              className="hidden sm:inline text-gray-200 hover:text-[#E7B8A8] transition"
            >
              📞 (608) 557-6282
            </a>
            <a
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 pt-20 pb-24 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto mb-10 text-base md:text-lg">
            Entrenamiento cognitivo diseñado para camioneros latinos en Estados Unidos. Aprendes las
            frases reales del inspector DOT, practicas respuestas y dominas el proceso completo de
          ...
          <div className="mt-10 max-w-3xl mx-auto">
            ...
            <p className="text-gray-300 text-xs md:text-sm mt-3">
              En solo 8 segundos ves el corazón de EL-VÍA: inglés operativo, inteligencia artificial y
              un entrenamiento que evoluciona contigo en cada inspección DOT.
            </p>
          </div>
        </div>
      </section>

      {/* VIDEO DE IMPACTO – NUEVO */}
      <section className="pt-10 pb-20 border-t border-[#2A2A2A] bg-[#050505]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="rounded-3xl overflow-hidden border border-[#E7B8A8]/60 shadow-[0_0_50px_rgba(231,184,168,0.35)]">
            <video
          ...
          <p className="text-gray-300 text-sm md:text-base mt-4 max-w-2xl mx-auto">
            Este video resume el miedo, los errores más comunes y el poder de dominar el idioma
            operativo del DOT. Cada palabra y cada gesto pueden cambiar el resultado de tu inspección.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-[1.3fr,1.1fr] gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              EL-VÍA es un entrenamiento práctico, bilingüe y guiado por IA soberana, que te prepara
              para enfrentar inspecciones DOT reales. No es solo un curso de inglés: es el idioma
              operativo del DOT, explicado paso a paso, con simulaciones reales y retroalimentación
              inmediata.
            </p>
            <p className="text-gray-400 text-sm mb-4">
              En 7 días y con 20 minutos al día puedes dominar lo que realmente ven en carretera:
              preguntas del inspector, documentos, señalización, respuestas correctas y errores que
              nunca deberías cometer.
            </p>
            <p className="text-gray-400 text-sm">
              Todo esto vive dentro del ecosistema SOLYON: una arquitectura DeepTech que conecta tu
              progreso con agentes cognitivos dedicados, diseñados exclusivamente para camioneros
              latinos.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <div className="bg-[#080808] border border-[#E7B8A8]/40 rounded-3xl p-5 shadow-[0_0_40px_rgba(231,184,168,0.18)]">
              <h3 className="text-lg font-semibold text-[#E7B8A8] mb-3">
                Ecosistema SOLYON para EL-VÍA
              </h3>
              <p className="text-gray-300 text-sm mb-3">
                EL-VÍA no es un curso suelto: es el primer producto comercial del ecosistema SOLYON
                Technologies. Detrás de cada pantalla hay una orquesta tecnológica completa:
              </p>
              <ul className="text-gray-300 text-sm space-y-2">
                <li>
                  • <span className="text-[#E7B8A8] font-semibold">Arcanum</span>: cerebro cognitivo
                  soberano donde viven los modelos de IA.
                </li>
                <li>
                  • <span className="text-[#E7B8A8] font-semibold">Nexus</span>: sistema nervioso que
                  coordina tu progreso, intentos y retroalimentación.
                </li>
                <li>
                  • Infraestructura desplegada en la nube de Google (Vertex AI), pensada para escalar a
            ...
            <div className="bg-[#080808] border border-[#E7B8A8]/40 rounded-3xl p-5 shadow-[0_0_40px_rgba(231,184,168,0.18)]">
              <h3 className="text-lg font-semibold text-[#E7B8A8] mb-3">
                2 agentes cognitivos dedicados a EL-VÍA
              </h3>
              <p className="text-gray-300 text-sm mb-3">
                Dentro de EL-VÍA trabajan dos agentes cognitivos exclusivos, entrenados para hablar el
                mismo idioma que el DOT y el camionero latino:
              </p>
              <ul className="text-gray-300 text-sm space-y-2 mb-3">
                <li>
                  • <span className="text-[#E7B8A8] font-semibold">Agente Coach DOT</span>: te guía en
                  la lógica de las inspecciones, te explica qué mira el inspector y cómo responder de
                  forma clara y profesional.
                </li>
                <li>
                  • <span className="text-[#E7B8A8] font-semibold">Agente Lingüista</span>: te ayuda
                  con pronunciación, frases clave y comprensión real del inglés operativo que se usa en
                  carretera.
                </li>
              </ul>
              <p className="text-gray-400 text-xs">
                Estos agentes no reemplazan al instructor: amplifican tu aprendizaje, te corrigen en
                contexto y convierten cada sesión en una experiencia personalizada.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 border-t border-[#2A2A2A] bg-[#050505]">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold text-[#E7B8A8] mb-5">
              ¿Para quién es EL-VÍA?
            </h2>
        ...
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-[1fr,1.4fr] gap-10 items-center">
          <div className="flex flex-col items-center md:items-start">
            <div className="relative mb-4">
              ...
              <img
                src="/elvia/elizabeth.jpg"
                alt="Elizabeth Tamayo"
                className="relative w-40 h-40 md:w-48 md:h-48 object-cover rounded-full border border-[#E7B8A8]"
              />
            </div>
            <p className="text-sm uppercase tracking-[0.25em] text-[#E7B8A8] mb-1">
              By Elizabeth Tamayo
            </p>
            <p className="text-gray-300 text-sm">
              Co-fundadora de SOLYON Technologies · Creadora de EL-VÍA
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-300 mb-3">
              Mi misión siempre ha sido empoderar a los camioneros latinos. Durante años vi el miedo
              que genera el DOT en conductores que son excelentes en su trabajo, pero que no dominan
              el idioma ni los códigos del sistema.
            </p>
            <p className="text-gray-300 mb-3">
              EL-VÍA nació para cambiar eso. Para devolver confianza, precisión y oportunidades. Para
              que, sin importar tu acento o tu historia, puedas mirar al inspector a los ojos y saber
              exactamente qué decir y qué hacer.
            </p>
      ...
      <section
        id="videos"
        className="py-16 md:py-20 border-t border-[#2A2A2A] bg-[#050505]"
      >
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-semibold text-[#E7B8A8] text-center mb-10">
          ...
          <div className="mb-16">
            ...
            <div className="max-w-3xl mx-auto text-center mt-4">
              <h3 className="text-lg font-semibold text-[#E7B8A8] mb-1">
                {trailerVideo.title}
              </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
              {promoVideos.slice(0, 6).map((v) => (
                ...
                >
                  ...
                  <h4 className="text-base font-semibold text-[#E7B8A8] mb-1 text-center">
                    {v.title}
                  </h4>
      ...
      <section className="py-16 md:py-20 border-t border-[#2A2A2A]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto mt-6">
            ...
            demuestra dominio real del proceso DOT y del vocabulario crítico utilizado por
            inspectores.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 border-t border-[#2A2A2A] bg-[#050505]">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-[1.3fr,1fr] gap-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold text-[#E7B8A8] mb-6">
            ...
            <div className="space-y-4">
              {faqs.map((item) => (
                ...
                >
                  <p className="text-sm font-semibold text-[#E7B8A8] mb-1">
                    {item.question}
                  </p>
          ...
          <div className="bg-[#080808] border border-[#E7B8A8]/40 rounded-3xl p-6 shadow-[0_0_30px_rgba(231,184,168,0.3)] flex flex-col justify-between">
            <div>
              <h3 className="text-xl font-semibold text-[#E7B8A8] mb-3">
                Garantía y seguridad.
              </h3>
              <p className="text-gray-300 text-sm mb-3">
                Si aplicas el contenido de EL-VÍA y sientes que no te ayudó a entender mejor el
                proceso DOT, contáctanos durante los primeros 7 días. Revisaremos tu caso y
                buscaremos la mejor forma de apoyarte.
              </p>
              <p className="text-gray-400 text-xs">
                Tu inversión en conocimiento es menor que una sola multa DOT. La decisión
                inteligente es prepararte.
              </p>
            </div>
            <div className="mt-6">
              ...
              <p className="text-gray-300 text-sm mb-3">
                ¿Tienes varios conductores? Escríbenos para planes corporativos y entrenamiento
                recurrente.
              </p>
              <a
      ...
      <section className="py-20 border-t border-[#2A2A2A] bg-[#050505]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            EL-VÍA es la diferencia entre improvisar… y dominar el proceso. No vuelvas a una
          ...
          <p className="text-xs text-gray-500 mt-4">
            Acceso inmediato · Contenido bilingüe · IA personalizada · Actualizaciones 12 meses
          </p>
        </div>
      </section>
    </div>
